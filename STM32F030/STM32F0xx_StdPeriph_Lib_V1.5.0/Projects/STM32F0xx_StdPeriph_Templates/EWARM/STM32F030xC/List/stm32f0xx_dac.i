...
void DAC_Init(uint32_t DAC_Channel, DAC_InitTypeDef* DAC_InitStruct)
{
  ...
  tmpreg1 = ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->CR;
  ...
  ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->CR = tmpreg1;
}
...
void DAC_Cmd(uint32_t DAC_Channel, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->CR |= (((uint32_t)0x00000001) << DAC_Channel);
  }
  else
  {
...
void DAC_SoftwareTriggerCmd(uint32_t DAC_Channel, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->SWTRIGR |= (uint32_t)((uint32_t)0x00000001) << (DAC_Channel >> 4);
  }
  else
  {
...
void DAC_DualSoftwareTriggerCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->SWTRIGR |= ((uint32_t)0x00000003);
  }
  else
  {
     
    ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->SWTRIGR &= ((uint32_t)0xFFFFFFFC);
  }
}
...
void DAC_WaveGenerationCmd(uint32_t DAC_Channel, uint32_t DAC_Wave, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->CR |= DAC_Wave << DAC_Channel;
  }
  else
  {
...
void DAC_DMACmd(uint32_t DAC_Channel, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->CR |= (((uint32_t)0x00001000) << DAC_Channel);
  }
  else
  {
...
void DAC_ITConfig(uint32_t DAC_Channel, uint32_t DAC_IT, FunctionalState NewState)  
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->CR |=  (DAC_IT << DAC_Channel);
  }
  else
  {
     
    ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->CR &= (~(uint32_t)(DAC_IT << DAC_Channel));
  }
}
...
FlagStatus DAC_GetFlagStatus(uint32_t DAC_Channel, uint32_t DAC_FLAG)
{
  ...
  if ((((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->SR & (DAC_FLAG << DAC_Channel)) != (uint8_t)RESET)
  {
...
void DAC_ClearFlag(uint32_t DAC_Channel, uint32_t DAC_FLAG)
{
  ...
  ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->SR = (DAC_FLAG << DAC_Channel);
}
...
ITStatus DAC_GetITStatus(uint32_t DAC_Channel, uint32_t DAC_IT)
{
  ...
  enablestatus = (((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->CR & (DAC_IT << DAC_Channel)) ;
  
   
  if (((((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->SR & (DAC_IT << DAC_Channel)) != (uint32_t)RESET) && enablestatus)
  {
...
void DAC_ClearITPendingBit(uint32_t DAC_Channel, uint32_t DAC_IT)
{
  ...
  ((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x00007400))->SR = (DAC_IT << DAC_Channel);
}

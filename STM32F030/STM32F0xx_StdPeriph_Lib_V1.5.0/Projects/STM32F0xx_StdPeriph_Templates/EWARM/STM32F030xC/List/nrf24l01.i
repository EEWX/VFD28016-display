...
typedef enum
{
  NRF24L01_PA_Power_n18dBm      = (uint8_t)0x00,  
  NRF24L01_PA_Power_n12dBm      = (uint8_t)0x02,  
...
extern uint8_t nrf_tx_pipe[6][16];
extern uint8_t nrf_rx_pipe[6][16];
...
uint8_t nrf_tx_pipe[6][16];

uint8_t nrf_rx_pipe[6][16];
...
{  
  char cnt = 0;
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0008),GPIO_Mode_Out_PP_High_Fast);
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0010),GPIO_Mode_Out_PP_High_Fast);
  
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0020),GPIO_Mode_Out_PP_Low_Fast);
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0040),GPIO_Mode_Out_PP_High_Fast);
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0080),GPIO_Mode_In_FL_No_IT);
  
  CLK_PeripheralClockConfig(CLK_Peripheral_SPI1,ENABLE);
  SPI_Init(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),((uint16_t)0x0000),((uint16_t)0x0020),((uint16_t)0x0104),((uint16_t)0x0000),((uint16_t)0x0000),((uint16_t)0x0000),((uint16_t)0x0200),7);
  
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0004),GPIO_Mode_In_PU_IT);
  EXTI_SetPinSensitivity(EXTI_Pin_2,EXTI_Trigger_Falling);
  
  SPI_Cmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),ENABLE);
  atomTimerDelay(10);

  GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0008));	
  ...
  NRF24L01_DataPipeConfig(NRF24L01_pipe0,RX_ADDRESS,5,16,ENABLE,ENABLE);
...
uint8_t NRF24L01_Check(void)
{
	...
	uint8_t i; 
	NRF24L01_Write_Buf(0x20+0x10,TX_ADDRESS,5);
...
{
	uint8_t status;	
        while(SPI_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),SPI_FLAG_BSY) == SET);
   	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0010));                 
        while(SPI_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),SPI_FLAG_TXE) == RESET);
        SPI_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),reg);
        while(SPI_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),SPI_FLAG_RXNE) == RESET);
        status = SPI_ReceiveData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)));
        while(SPI_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),SPI_FLAG_TXE) == RESET);
  	SPI_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),value);      
        while(SPI_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),SPI_FLAG_BSY) == SET);
  	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0010));                 
  	return(status);       			
}
...
uint8_t NRF24L01_Read_Reg(uint8_t reg)
{
	uint8_t reg_val;	
 	...
 	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0010));          
  	...
  	SPI_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),reg);   
        while(SPI_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),SPI_FLAG_RXNE) == RESET);
        reg_val = SPI_ReceiveData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)));	                        
        while(SPI_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),SPI_FLAG_TXE) == RESET);
        SPI_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),0xFF);
        while(SPI_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),SPI_FLAG_RXNE) == RESET);
        reg_val = SPI_ReceiveData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)));
        while(SPI_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),SPI_FLAG_BSY) == SET);
  	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0010));          
 	...
 	for(u8_ctr=0;u8_ctr<len;u8_ctr++)
        {
          ...
          SPI_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),0xFF);
          while(SPI_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),SPI_FLAG_RXNE) == RESET);
          pBuf[u8_ctr] = SPI_ReceiveData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)));
        }
        while(SPI_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),SPI_FLAG_BSY) == SET);
  	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0010));       
  	return status;        
...
uint8_t NRF24L01_Write_Buf(uint8_t reg, uint8_t *pBuf, uint8_t len)
{
	...
	for(u8_ctr=0; u8_ctr<len; u8_ctr++)
        {
          while(SPI_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),SPI_FLAG_TXE) == RESET);
          SPI_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),*pBuf++); 
        }
        while(SPI_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00013000)),SPI_FLAG_BSY) == SET);
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0010));       
	return status;          
...
uint8_t NRF24L01_TxPacket(uint8_t *txbuf)
{
	...
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0008));
        NRF24L01_Write_Buf(0xA0,txbuf,16);
 	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0008));	   
...
{
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0008));	  
	NRF24L01_Write_Buf(0x20+0x0A,(uint8_t*)RX_ADDRESS,5);
	NRF24L01_Write_Reg(0x20+0x01,0x01);    
	NRF24L01_Write_Reg(0x20+0x02,0x01);
	NRF24L01_Write_Reg(0x20+0x05,0);	     
	NRF24L01_Write_Reg(0x20+0x11,16);
	NRF24L01_Write_Reg(0x20+0x06,0x26);
...
{														 
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),((uint16_t)0x0008));	    
	NRF24L01_Write_Buf(0x20+0x10,(uint8_t*)TX_ADDRESS,5);
	NRF24L01_Write_Buf(0x20+0x0A,(uint8_t*)RX_ADDRESS,5); 

	NRF24L01_Write_Reg(0x20+0x01,0x01);     
	NRF24L01_Write_Reg(0x20+0x02,0x01); 
	NRF24L01_Write_Reg(0x20+0x04,0xfa);
	NRF24L01_Write_Reg(0x20+0x05,0);       
	NRF24L01_Write_Reg(0x20+0x06,0x26);  
...
void NRF24L01_ModeManage(NRF24L01_Mode_TypeDef rf_mode)
{
  ...
  temp = NRF24L01_Read_Reg(0x00 + 0x00);
  
  switch(rf_mode)
  {
    case NRF24L01_Mode_PowerDown:
      temp &= 0xfd;
      NRF24L01_Write_Reg(0x20+0x00,temp);
...
void NRF24L01_RF_Config(uint8_t rf_channel,NRF24L01_PA_Power_TypeDef pa_power,NRF24L01_DataRate_TypeDef rf_data_rate,FunctionalState RF_cont_state)
{
  ...
  NRF24L01_Write_Reg(0x20+0x05,rf_channel);
  ...
  NRF24L01_Write_Reg(0x20+0x06,temp);
}
...
void NRF24L01_DataPipeConfig(NRF24L01_pipe_TypeDef pipe,uint8_t *pipe_rx_address,uint8_t pipe_rx_adr_width,uint8_t pipe_rx_bytes,FunctionalState AutoACK_NewState,FunctionalState PipeNewState)
{
  ...
  temp = NRF24L01_Read_Reg(0x00 + 0x01);
  if(AutoACK_NewState)
  {
    NRF24L01_Write_Reg(0x20+0x01, temp | pipe_index);
  }
  else
  {
    NRF24L01_Write_Reg(0x20+0x01,temp & ~pipe_index);
  ...
  if(pipe < 2)
  {
    NRF24L01_Write_Buf(0x20+0x0A + pipe,(uint8_t*)pipe_rx_address,pipe_rx_adr_width);
  }
  else  
  {
    NRF24L01_Write_Reg(0x20+0x0A + pipe,*pipe_rx_address);
  }
  
  temp = NRF24L01_Read_Reg(0x00 + 0x02);
  if(PipeNewState)
  {
    NRF24L01_Write_Reg(0x20+0x11+pipe, pipe_rx_bytes);
    NRF24L01_Write_Reg(0x20+0x02, temp | pipe_index);
  }
  else
  {
    NRF24L01_Write_Reg(0x20+0x02,temp & ~pipe_index);
...
void NRF24L01_CRC_Config(NRF24L01_CRC_TypeDef crc,FunctionalState crc_status)
{
  ...
  NRF24L01_Write_Reg(0x20+0x00, temp | crc);
}

void NRF24L01_SetTX_Address(uint8_t *tx_address,uint8_t tx_adr_width)
{
  NRF24L01_Write_Buf(0x20 + 0x10,(uint8_t*)tx_address,tx_adr_width);
}

uint8_t NRF24L01_GetPendingFlags(void)
{
  uint8_t temp;
  temp = NRF24L01_Read_Reg(0x00 + 0x07);
  return(temp&0x70);
}
...
void NRF24L01_ClearPendingFlag(NRF24L01_Flag_TypeDef rf_flag)
{
  uint8_t temp;
  temp = NRF24L01_Read_Reg(0x00 + 0x07);
  NRF24L01_Write_Reg(0x20+0x07,temp | rf_flag);
}

...
uint8_t CAN_Init(CAN_TypeDef* CANx, CAN_InitTypeDef* CAN_InitStruct)
{
  ...
  while (((CANx->MSR & ((uint16_t)0x0001)) != ((uint16_t)0x0001)) && (wait_ack != ((uint32_t)0x00FFFFFF)))
  {
    wait_ack++;
  }
  ...
  else 
  {
   ...
   while (((CANx->MSR & ((uint16_t)0x0001)) == (uint16_t)((uint16_t)0x0001)) && (wait_ack != ((uint32_t)0x00FFFFFF)))
   {
     wait_ack++;
   }
...
void CAN_FilterInit(CAN_FilterInitTypeDef* CAN_FilterInitStruct)
{
  ...
  ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x00006400))->FMR |= ((uint32_t)0x00000001);

   
  ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x00006400))->FA1R &= ~(uint32_t)filter_number_bit_pos;

   
  if (CAN_FilterInitStruct->CAN_FilterScale == ((uint8_t)0x00))
  {
     
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x00006400))->FS1R &= ~(uint32_t)filter_number_bit_pos;

     
     
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x00006400))->sFilterRegister[CAN_FilterInitStruct->CAN_FilterNumber].FR1 = 
       ((0x0000FFFF & (uint32_t)CAN_FilterInitStruct->CAN_FilterMaskIdLow) << 16) |
        (0x0000FFFF & (uint32_t)CAN_FilterInitStruct->CAN_FilterIdLow);

     
     
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x00006400))->sFilterRegister[CAN_FilterInitStruct->CAN_FilterNumber].FR2 = 
  ...
  if (CAN_FilterInitStruct->CAN_FilterScale == ((uint8_t)0x01))
  {
    ...
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x00006400))->FS1R |= filter_number_bit_pos;
  ...
  if (CAN_FilterInitStruct->CAN_FilterMode == ((uint8_t)0x00))
  {
    ...
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x00006400))->FM1R &= ~(uint32_t)filter_number_bit_pos;
  }
  else  
  {
  ...
  if (CAN_FilterInitStruct->CAN_FilterFIFOAssignment == ((uint8_t)0x00))
  {
    ...
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x00006400))->FFA1R &= ~(uint32_t)filter_number_bit_pos;
  }
  ...
  {
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x00006400))->FA1R |= filter_number_bit_pos;
  }
...
void CAN_SlaveStartBank(uint8_t CAN_BankNumber) 
{
  ...
  ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x00006400))->FMR &= (uint32_t)0xFFFFC0F1 ;
  ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x00006400))->FMR |= (uint32_t)(CAN_BankNumber)<<8;
...
uint8_t CAN_OperatingModeRequest(CAN_TypeDef* CANx, uint8_t CAN_OperatingMode)
{
  ...
  uint32_t timeout = ((uint32_t)0x00FFFFFF); 
...
uint8_t CAN_WakeUp(CAN_TypeDef* CANx)
{
  uint32_t wait_slak = ((uint32_t)0x00FFFFFF);

...
extern volatile uint8_t Usart_Timeout;
extern volatile FunctionalState Usart_Timeout_State;
extern volatile uint8_t Usart_Receive_Pointer;
extern uint8_t Usart_Send_Buf[10];
extern const uint8_t Instructions[8][40];
...
volatile uint8_t Usart_Timeout = 0;
volatile FunctionalState Usart_Timeout_State = DISABLE;
volatile uint8_t Usart_Receive_Pointer = 0;


  
const uint8_t CommandTable[9][4]=
{
  {'N','U','L','L'}, 
  {'A','S','C','H'}, 
  {'A','S','C','L'}, 
...
const uint8_t Instructions[8][40]=
{
...
void Usart_Init(void)
{
  ...
  GPIO_Type.GPIO_Pin = ((uint16_t)0x0200);
  ...
  GPIO_Type.GPIO_Pin = ((uint16_t)0x0400);
  GPIO_Type.GPIO_PuPd = GPIO_PuPd_NOPULL;
  GPIO_Type.GPIO_Speed = GPIO_Speed_Level_1;
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),&GPIO_Type); 
  
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)), ((uint8_t)0x0A), ((uint8_t)0x01)); 
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)), ((uint8_t)0x09), ((uint8_t)0x01)); 
  
  UART_Type.USART_BaudRate = 115200;
  UART_Type.USART_HardwareFlowControl = ((uint32_t)0x00000000);
  UART_Type.USART_Mode = ((uint32_t)0x00000004) | ((uint32_t)0x00000008);
  UART_Type.USART_Parity = ((uint32_t)0x00000000);
  UART_Type.USART_StopBits = ((uint32_t)0x00000000);
  UART_Type.USART_WordLength = ((uint32_t)0x00000000);
  ...
  USART_Init(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)),&UART_Type);
  USART_SetReceiverTimeOut(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)),1000);
  USART_ReceiverTimeOutCmd(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)),ENABLE);
  USART_ITConfig(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)),((uint32_t)0x00050105),ENABLE);
  USART_ITConfig(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)),((uint32_t)0x000B011A),ENABLE);
  USART_Cmd(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)),ENABLE);
}

void Usart_Send_Byte(uint8_t data)
{
  
  USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)),data);
  while(USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)),((uint32_t)0x00000080)) == RESET);
...
void Usart_Send_Bytes(uint8_t *p,uint8_t length)
{
  ...
  while(length--)
  {
    USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)),*p);
    while(USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)),((uint32_t)0x00000080)) == RESET);
    p++;
  }

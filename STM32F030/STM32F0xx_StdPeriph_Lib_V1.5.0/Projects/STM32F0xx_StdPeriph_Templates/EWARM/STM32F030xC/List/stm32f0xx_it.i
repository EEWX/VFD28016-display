...
void SysTick_Handler(void)
{
  if(DisplayUpdateFlag != RESET)
  {
    ...
    DMA_Cmd(((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000030)),DISABLE);
    DMA_SetCurrDataCounter(((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000030)),12);
...
void DMA1_Channel2_3_IRQHandler(void)
{
  ...
  DMA_ClearITPendingBit(((uint32_t)0x00000200));
}
...
void USART1_IRQHandler(void)
{
  ...
  if(USART_GetITStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)),((uint32_t)0x000B011A)))
  {
    USART_ClearITPendingBit(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)),((uint32_t)0x000B011A));
    if(receive_cnt)
    {
  ...
  {
    received_buf[receive_cnt] = USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00013800)));
    receive_cnt++;  

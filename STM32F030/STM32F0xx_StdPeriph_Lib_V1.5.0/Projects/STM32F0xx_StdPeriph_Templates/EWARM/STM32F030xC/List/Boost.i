...
uint16_t BoostVoltageSetpoint = 355;      
void BOOST_Init(void)
{
  ...
  GPIO_Type.GPIO_Pin = ((uint16_t)0x0002);
  ...
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)), ((uint8_t)0x01), ((uint8_t)0x00)); 
  
  RCC_APB1PeriphClockCmd(((uint32_t)0x00000100),ENABLE);
  
  TIM_Type.TIM_ClockDivision = ((uint16_t)0x0000);
  TIM_Type.TIM_CounterMode = ((uint16_t)0x0000);
  TIM_Type.TIM_Period = 1000;
  TIM_Type.TIM_Prescaler = 0;
  TIM_Type.TIM_RepetitionCounter = 0;
  
  TIM_DeInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00002000)));
  TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00002000)),&TIM_Type);
  TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00002000)),ENABLE);
  ...
  TIM_OC1Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00002000)), &TIM_OC_Type);
}

  ...
  switch (tmp)
  {
    ...
    case 0x08:   
      ...
      else
      {
        ...
        SystemCoreClock = (((uint32_t)16000000) / prediv1factor) * pllmull; 
      }      
      break;
    default:  
      SystemCoreClock = ((uint32_t)8000000);
...
static void SetSysClock(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR |= (uint32_t)(((uint32_t)0x00010000) | ((uint32_t)0x00000000) | ((uint32_t)0x00040000));  

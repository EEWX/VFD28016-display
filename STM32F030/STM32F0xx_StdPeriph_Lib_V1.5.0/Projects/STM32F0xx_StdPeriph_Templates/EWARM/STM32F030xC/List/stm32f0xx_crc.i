...
void CRC_DeInit(void)
{
  ...
  ((CRC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->POL = 0x04C11DB7;
...
void CRC_PolynomialSizeSelect(uint32_t CRC_PolSize)
{
  ...
  tmpcr &= (uint32_t)~((uint32_t)((uint32_t)0x00000018));
...
void CRC_SetPolynomial(uint32_t CRC_Pol)
{
  ((CRC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->POL = CRC_Pol;
}

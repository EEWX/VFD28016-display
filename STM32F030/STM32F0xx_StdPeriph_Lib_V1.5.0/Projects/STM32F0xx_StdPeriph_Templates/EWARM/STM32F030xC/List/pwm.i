...
extern uint16_t FeedbackCounter;
extern ErrorStatus LoopStatus;
extern uint16_t PWM_Frequency;
void PWM_Init(void);
void PWM_Config(TIM2_Prescaler_TypeDef prescaler,uint16_t cnt);

uint16_t PWM_Frequency = 200;
uint16_t FeedbackCounter = 0;
ErrorStatus LoopStatus = SUCCESS;
void PWM_Init(void)
{
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000C00)),GPIO_PIN_3,GPIO_MODE_OUT_PP_LOW_FAST);
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000800)),GPIO_PIN_4,GPIO_MODE_IN_FL_IT);
  EXTI_SetExtIntSensitivity(EXTI_PORT_GPIOC,EXTI_SENSITIVITY_FALL_ONLY);
  TIM2_DeInit();
  TIM2_TimeBaseInit(TIM2_PRESCALER_8,6912);
  TIM2_OC2Init(TIM2_OCMODE_PWM1,TIM2_OUTPUTSTATE_ENABLE,3456,TIM2_OCPOLARITY_HIGH);
...
{
  TIM2_DeInit();
  TIM2_TimeBaseInit(prescaler,cnt);
  TIM2_OC2Init(TIM2_OCMODE_PWM1,TIM2_OUTPUTSTATE_ENABLE,cnt/2,TIM2_OCPOLARITY_HIGH);
  TIM2_Cmd(ENABLE);
}

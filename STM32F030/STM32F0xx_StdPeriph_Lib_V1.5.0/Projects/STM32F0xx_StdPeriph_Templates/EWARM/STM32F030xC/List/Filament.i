...
void FILAMENT_Init(void)
{
  ...
  GPIO_Type.GPIO_Pin = ((uint16_t)0x0040);
  ...
  GPIO_Type.GPIO_Pin = ((uint16_t)0x0080);
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),&GPIO_Type); 
  
  GPIO_Type.GPIO_Mode = GPIO_Mode_AN;
  GPIO_Type.GPIO_OType = GPIO_OType_OD;
  GPIO_Type.GPIO_Pin = ((uint16_t)0x0001);
  GPIO_Type.GPIO_PuPd = GPIO_PuPd_NOPULL;
  GPIO_Type.GPIO_Speed = GPIO_Speed_Level_1;
  
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),&GPIO_Type);		
  
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)), ((uint8_t)0x06), ((uint8_t)0x01)); 
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)), ((uint8_t)0x07), ((uint8_t)0x01)); 
  
  RCC_APB1PeriphClockCmd(((uint32_t)0x00000002),ENABLE);
  
  TIM_Type.TIM_ClockDivision = ((uint16_t)0x0000);
  TIM_Type.TIM_CounterMode = ((uint16_t)0x0020);
  TIM_Type.TIM_Period = 500;
  TIM_Type.TIM_Prescaler = 0;
  TIM_Type.TIM_RepetitionCounter = 0;
  
  
  
  TIM_DeInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00000400)));
  TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00000400)),&TIM_Type);
  TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00000400)),ENABLE);
  
  TIM_OC_Type.TIM_OCIdleState = ((uint16_t)0x0000);
  TIM_OC_Type.TIM_OCMode = ((uint16_t)0x0060);
  TIM_OC_Type.TIM_OCNIdleState = ((uint16_t)0x0000);
  TIM_OC_Type.TIM_OCNPolarity = ((uint16_t)0x0000);
  TIM_OC_Type.TIM_OCPolarity = ((uint16_t)0x0000);
  TIM_OC_Type.TIM_OutputNState = ((uint16_t)0x0000);
  TIM_OC_Type.TIM_OutputState = ((uint16_t)0x0001);
  TIM_OC_Type.TIM_Pulse = 35;
  TIM_OC1Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00000400)), &TIM_OC_Type);
  
  TIM_OC_Type.TIM_OCIdleState = ((uint16_t)0x0100);
  TIM_OC_Type.TIM_OCMode = ((uint16_t)0x0060);
  TIM_OC_Type.TIM_OCNIdleState = ((uint16_t)0x0000);
  TIM_OC_Type.TIM_OCNPolarity = ((uint16_t)0x0000);
  TIM_OC_Type.TIM_OCPolarity = ((uint16_t)0x0002);
  TIM_OC_Type.TIM_OutputNState = ((uint16_t)0x0000);
  TIM_OC_Type.TIM_OutputState = ((uint16_t)0x0001);
  TIM_OC_Type.TIM_Pulse = 500 - 35;
  TIM_OC2Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00000400)), &TIM_OC_Type);
